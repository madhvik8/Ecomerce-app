...
const Product = () => {
  ...
  !Object.keys(product).length > 0 && <div>Product Nott Found</div>;
  return (
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex justify-between item-center mt-20">
              ...
              <div className="flex">
                ...
                <button className="flex ml-auto border border-indigo-500 py-2 px-6  focus:outline-none hover:bg-indigo-600 hover text-black rounded">
                  Add To Cart
                </button>
              </div>
